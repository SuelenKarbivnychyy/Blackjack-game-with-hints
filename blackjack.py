...
def calculate_score(list_of_cards):
    """Canculate the sum of cards and return it as score"""
...
def compare(user_score, computer_score):
    """Compare the scores and nominate a winner."""
    ...
    if user_score == computer_score:
        ...
        return "User won with a BLACKJACK"
    elif user_score > 21:
        return f"User lost, score: {user_score}"  
    elif computer_score > 21:
        return "Computer lost"    
    elif user_score > computer_score:
        return "User won with the higly score."
    else:
        return "Computer won with the greatest score."    
...
def play_game():
    ...
    #Hint 9: Call calculate_score(). If the computer or the user has a blackjack (0) or if the user's score is over 21, then the game ends.
        ...
        if user_score == 0 or computer_score == 0 or user_score > 21:
            ...
            wants_to_draw_a_card = input("Type 'y' to draw a card or 'n' to pass: ")     
...
while input("Do you wanna play a Blackjack game, type 'y' or 'n'? ") == 'y':
    print(art.logo) 
    play_game()
